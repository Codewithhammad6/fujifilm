<%@ Page language="c#" Codebehind="Sub_ChangeImg.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.Sub_ChangeImg" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file Sub_ChangeImg.aspx

  @brief 画像入れ替えサブメインフレーム
...
<LINK REL="stylesheet" TYPE="text/css" HREF="CSS/Sub_ChangeImg.css">
...
<BODY ONLOAD="Public_ClearStirngCount();Public_ClearLangMsgStirngCount();Fn_InitPage();" ONBEFOREUNLOAD="Public_BeforeUnload();">
  <IFRAME ID="CHANGEIMG_CTRL" SCROLLING="no" FRAMEBORDER="0">
  </IFRAME>
</BODY>
</HTML>