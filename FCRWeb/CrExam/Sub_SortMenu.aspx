<%@ Page language="c#" Codebehind="Sub_SortMenu.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.Sub_SortMenu" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file Sub_SortMenu.aspx

  @brief メニュー並べ替えサブメインフレーム
...
<LINK REL="stylesheet" TYPE="text/css" HREF="CSS/Sub_SortMenu.css">
...
<script language="javascript">
      ...
      var FILE_NAME_ASPX = "Sub_SortMenu.aspx"  //ファイル名
		// 文字列数
...
<BODY ONLOAD="Public_ClearStirngCount();Public_ClearLangMsgStirngCount();Fn_InitPage();">
  <IFRAME ID="SORTMENU_CTRL" SCROLLING="no" FRAMEBORDER="0">
  </IFRAME>
</BODY>
</HTML>