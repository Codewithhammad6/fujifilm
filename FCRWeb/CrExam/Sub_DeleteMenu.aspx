<%@ Page language="c#" Codebehind="Sub_DeleteMenu.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.Sub_DeleteMenu" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file Sub_DeleteMenu.aspx

  @brief メニュー削除サブメインフレーム
...
<LINK REL="stylesheet" TYPE="text/css" HREF="CSS/Sub_DeleteMenu.css">
...
<SCRIPT LANGUAGE="JavaScript" SRC="Include/Sub_DeleteMenu.js" CHARSET="UTF-8"></SCRIPT>
<script language="javascript" src="./Include/GetString.js" charset="UTF-8"></script>
<SCRIPT LANGUAGE="JavaScript" SRC="Include/MessageWindow.js"		CHARSET="UTF-8"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript">
	try{
    var SPOT_CODE_ASPX = 0;                   //スポットコード
    var FILE_NAME_ASPX = "Sub_DeleteMenu.aspx"  //ファイル名
...
<BODY ONLOAD="Public_ClearStirngCount();Public_ClearLangMsgStirngCount();Fn_InitPage();">
  <IFRAME ID="DELETEMENU_CTRL" SCROLLING="no" FRAMEBORDER="0">
  </IFRAME>
</BODY>
</HTML>