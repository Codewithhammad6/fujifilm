<%@ Page language="c#" Codebehind="Sub_Study.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.Sub_Study" ASPCOMPAT="true" %>
<%
/****************************************************************************
...
<LINK REL="stylesheet" TYPE="text/css" HREF="CSS/Sub_Study.css">
...
<SCRIPT LANGUAGE="JavaScript" SRC="Include/Sub_Study.js"		     CHARSET="UTF-8"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="Include/GetString.js"         CHARSET="UTF-8"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript">
 	try{
    var SPOT_CODE_ASPX = 0;                   //スポットコード
    var FILE_NAME_ASPX = "Sub_Study.aspx"  //ファイル名
 // 文字列数
...
<BODY ONLOAD="Public_ClearStirngCount();Public_ClearLangMsgStirngCount();Fn_InitPage();">
  <IFRAME ID="STUDY_CTRL"	 SCROLLING="no" FRAMEBORDER="0"></IFRAME>
	<IFRAME ID="MODIFY_CTRL" SCROLLING="no" FRAMEBORDER="0"></IFRAME>
</BODY>
</HTML>