<%@ Page language="c#" Codebehind="Sub_RegistStudy.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.Sub_RegistStudy" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file Sub_RegistStudy.aspx
...
<HTML>
  <HEAD>
    ...
    <LINK REL="stylesheet" TYPE="text/css" HREF="CSS/Sub_RegistStudy.css">
    ...
    <SCRIPT LANGUAGE="JavaScript" SRC="./Include/Sub_RegistStudy.js" CHARSET="UTF-8"></SCRIPT>
	  <SCRIPT LANGUAGE="JavaScript" SRC="./Include/MessageWindow.js"   CHARSET="UTF-8"></SCRIPT>
	  <SCRIPT LANGUAGE="JavaScript" SRC="./Include/GetString.js"   CHARSET="UTF-8"></SCRIPT>
		<SCRIPT LANGUAGE="JavaScript">
		try{
      var SPOT_CODE_ASPX = 0;                   //スポットコード
      var FILE_NAME_ASPX = "Sub_RegistStudy.aspx"  //ファイル名
	// 文字列数
...
%>
  ...
  <BODY ONLOAD="Public_ClearStirngCount();Public_ClearLangMsgStirngCount();Fn_InitPage()">
		<!-- 検査登録機能フレーム //-->
		<IFRAME ID="REGISTSTUDY_CTRL" FRAMEBORDER=0 tabindex=-1></IFRAME>
  </BODY>
</HTML>
