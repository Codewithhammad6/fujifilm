<%@ Page language="c#" Codebehind="SortMenu_Ctrl.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.SortMenu_Ctrl" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file SortMenu_Ctrl.aspx
...
<HTML>
  <HEAD>
    ...
    <LINK REL="stylesheet" TYPE="text/css" HREF="CSS/SortMenu_Ctrl.css">
    ...
    <SCRIPT LANGUAGE="JavaScript" SRC="Include/SortMenu_Ctrl.js" CHARSET="UTF-8"></SCRIPT>
		<SCRIPT LANGUAGE="JavaScript">
		try{
      var SPOT_CODE_ASPX = 0;                   //スポットコード
      var FILE_NAME_ASPX = "Sprt<emi_Ctrl.aspx"  //ファイル名
		  // 画面オープンモード
  ...
  <BODY ONLOAD="Fn_InitPage();">
    ...
    <IFRAME ID="SORTMENU_VIEW"				SCROLLING="no" FRAMEBORDER="0"></IFRAME>
    <IFRAME ID="SORTMENU_UPDATE_PROC" SCROLLING="no" FRAMEBORDER="0"></IFRAME>
