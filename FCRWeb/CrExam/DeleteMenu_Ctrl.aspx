<%@ Page language="c#" Codebehind="DeleteMenu_Ctrl.aspx.cs" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.DeleteMenu_Ctrl" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file DeleteMenu_Ctrl.aspx

  @brief メニュー削除／画像無効化機能フレーム
...
<LINK REL="stylesheet" TYPE="text/css" HREF="CSS/DeleteMenu_Ctrl.css">
...
<SCRIPT LANGUAGE="JavaScript" SRC="Include/DeleteMenu_Ctrl.js"	 CHARSET="UTF-8"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="./Include/Control.js"         CHARSET="UTF-8"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript">
  try{
    var SPOT_CODE_ASPX = 0;                   //スポットコード
    var FILE_NAME_ASPX = "DeleteMenu_Ctrl.aspx"  //ファイル名
	  // 画面オープンモード
...
<BODY ONLOAD="Fn_InitPage();">
  <IFRAME ID="DELETEMENU_VIEW"				SCROLLING="no" FRAMEBORDER="0"></IFRAME>  	
  <IFRAME ID="DELETEMENU_UPDATE_PROC" SCROLLING="no" FRAMEBORDER="0"></IFRAME>  	
