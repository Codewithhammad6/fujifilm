<%@ Page language="c#" Codebehind="RegAddMenu_Update_Proc.aspx.cs" EnableSessionState="false" AutoEventWireup="false" Inherits="HobbitWeb.CrExam.RegAddMenu_Update_Proc" ASPCOMPAT="true" %>
<%
/****************************************************************************

  @file RegAddMenu_Update_Proc.aspx

  @brief メニュー追加更新処理フレーム
...
<HTML>
  <HEAD>
    <TITLE>RegAddMenu_Update_Proc</TITLE>
    <meta name="GENERATOR"						Content="Microsoft Visual Studio .NET 7.1">
    <meta name="CODE_LANGUAGE"				Content="C#">
    <meta name=vs_defaultClientScript Content="JavaScript">
    <meta name=vs_targetSchema				Content="http://schemas.microsoft.com/intellisense/ie5">
    <SCRIPT LANGUAGE="JavaScript"	SRC="Include/RegAddMenu_Update_Proc.js" CHARSET="UTF-8"></SCRIPT>
