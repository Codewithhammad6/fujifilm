/****************************************************************************
  ...
  @file RegChangeMenu_Ctrl.js

  @brief RegChangeMenu_Ctrlのクライアントスクリプト
...
var FILE_NAME = "RegChangeMenu_Ctrl.js"  //ファイル名
...
var PROC_MODE     = "REGCHANGEMENU_CTRL";
...
function Fn_InitPage(){
    ...
    // 排他モード設定
		...
		loader.AddLoadPage("CHANGEMENU_VIEW","RegAddMenu_View.aspx?RegMenuMode=2&OpenMode=" + OpenMode);
...
function Public_Init(){
	try{
        ...
        var moveViewInfo = new MoveViewInfo("CHANGEMENU_VIEW");
