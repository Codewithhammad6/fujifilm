/****************************************************************************
  ...
  @file RegAddMenu_Ctrl.js

  @brief RegAddMenuのクライアントスクリプト
...
var FILE_NAME = "RegAddMenu_Ctrl.js"  //ファイル名
...
function Fn_InitPage(){
	try{
  	// 排他モード設定
		...
		loader.AddLoadPage("REGSTUDY_UPDATE_PROC","RegStudy_Update_Proc.aspx");
		loader.AddLoadPage("ADDMENU_VIEW","RegAddMenu_View.aspx?RegMenuMode=1&OpenMode=" + OpenMode); 
...
function Public_Init(){
	try{
        ...
        var moveViewInfo = new MoveViewInfo("ADDMENU_VIEW");
