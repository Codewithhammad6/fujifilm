...
//[定数]
var PROC_MODE_OUTPUT     = "OUTPUT_CTRL";
...
var FILE_NAME           = "Sub_Output.js"           //ファイル名
...
function Fn_InitPage(){
	try{
		LoadPage(PROC_MODE_OUTPUT,"Output_Ctrl.aspx?OpenMode=2");
	}catch(e){
...
function Public_Init()
{
    try{
        // 初期呼び出し
        OUTPUT_CTRL.Public_Init();
        // コールバック関数の登録
        OUTPUT_CTRL.SetFrameFinishedNotification(CtrlFinished, "");
    }catch(e){
