/****************************************************************************
  ...
  @file Sub_SortMenu.js

  @brief Sub_SortMenuのクライアントスクリプト
...
var FILE_NAME           = "Sub_SortMenu.js"           //ファイル名
...
function Fn_InitPage(){
  try{
	LoadPage("SORTMENU_CTRL","SortMenu_Ctrl.aspx?OpenMode=2");
  }
  catch(exception){
...
function Public_Init(){
    try{
        SORTMENU_CTRL.Public_Init();
        // コールバック関数の登録
        SORTMENU_CTRL.SetFrameFinishedNotification(CtrlFinished, "");
    }
    catch(exception){
