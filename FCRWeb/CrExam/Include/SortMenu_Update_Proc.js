/****************************************************************************
  ...
  @file SortMenu_Update_Proc.js

  @brief SortMenu_Update_Procのクライアントスクリプト
...
//　　  なし//
// ３．備考//*****************************************************************************
function Public_Update(procMode, studySequence, sendImageSeq,studyStatus){
  try{
    //更新情報をセット
