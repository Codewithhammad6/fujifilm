/****************************************************************************
  ...
  @file ChangeImg_Update_Proc.js

  @brief ChangeImg_Update_Procのクライアントスクリプト
...
//
// １．機能
//     ＣＲ検査操作コンポーネントに更新処理を要求する//
// ２．戻り値
//　　  なし//
// ３．備考//*****************************************************************************
function Public_Update(procMode, studySequence, sendImageSeq, studyStatus, patientId){
  try{
    //更新情報をセット
