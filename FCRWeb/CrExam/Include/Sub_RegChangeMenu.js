/****************************************************************************
  ...
  @file Sub_RegChangeMenu.js

  @brief Sub_RegChangeMenuのクライアントスクリプト
...
var FILE_NAME           = "Sub_RegChangeMenu.js"           //ファイル名
...
function Fn_InitPage(){
  ...
  try{
		LoadPage("REGCHANGEMENU_CTRL","RegChangeMenu_Ctrl.aspx?OpenMode=2");
  }
  catch(e){
...
function Public_Init(){
    try{
        REGCHANGEMENU_CTRL.Public_Init();
        // コールバック関数の登録
        REGCHANGEMENU_CTRL.SetFrameFinishedNotification(CtrlFinished, "");
    }
    catch(e){
