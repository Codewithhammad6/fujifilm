/****************************************************************************
  ...
  @file SortMenu_Ctrl.js

  @brief SortMenu_Ctrlのクライアントスクリプト
...
var FILE_NAME            = "SortMenu_Ctrl.js";//ファイル名
...
function Fn_InitPage(){
  try{
	  ...
	  if(OpenMode == OPEN_MODE_DIALOG){
		...
		loader.AddLoadPage("SORTMENU_VIEW","SortMenu_View.aspx?OpenMode=" + OpenMode);  
		//ロード開始
...
function Public_Init(){
  try{
        ...
        var moveViewInfo = new MoveViewInfo("SORTMENU_VIEW");
