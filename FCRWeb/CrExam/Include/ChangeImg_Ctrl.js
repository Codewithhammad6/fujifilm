/****************************************************************************
  ...
  @file ChangeImg_Ctrl.js

  @brief ChangeImgのクライアントスクリプト
...
var FILE_NAME   = "ChangeImg_Ctrl.js";//ファイル名
...
// ADD 2005/02/03 hata============
var ModifyStatusFlag = 0;	// 修正完了状況フラグ(0:修正未 1:修正完了(未撮なし)  2:修正完了(未撮有))
//ADD EN===========================
...
function Fn_InitPage(){
  try{
		...
		loader.AddLoadPage("CHANGEIMG_VIEW","ChangeImg_View.aspx?OpenMode=" + OpenMode);
		//ロード開始
...
function Public_Init(){
  try{
    ...
    Public_ErrorDisplay(FATAL_ERROR, MESSAGE_ID, FILE_NAME, SPOT_CODE+1);
	 ...
	 var moveViewInfo = new MoveViewInfo("CHANGEIMG_VIEW");
